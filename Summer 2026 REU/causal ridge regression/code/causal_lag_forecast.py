"""Forecast-only causal lag/ridge model for Step 1 of the REU ladder.

This script does not run Gurobi and does not compute dispatch, revenue, or
COVE. It rebuilds the power forecast used before the dispatch steps.
"""
...
def main():
    ...
    parser.add_argument("--output-dir", default=str(DEFAULT_OUTPUT), help="Directory for metrics and prediction CSVs.")
