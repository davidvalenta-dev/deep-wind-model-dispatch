...
| Daily-replan oracle | Perfect-information oracle that executes 24 hours before replanning. |
| Hourly-replan oracle reference | Perfect-information oracle that executes only 1 hour before replanning. |
| COVE | Cost of Valued Energy. Lower is better. In these outputs, COVE reduction means the percent reduction in COVE relative to the benchmark. |
