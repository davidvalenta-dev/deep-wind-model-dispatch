...
2. Hourly-replan oracle reference: solve 168 hours, execute 1 hour, then replan.
...
Separate hourly-replan oracle reference:
...
| `results/hourly_168h_oracle_ceiling/oracle_dispatch_168h.csv` | Hourly 168 h oracle reference hourly CSV |
