...
class VFLoss(nn.Module):
    ...
    def forward(self, released, stored, power, price, battery_rating=None, battery_duration=None):
        B = power.shape[0]
        T = power.shape[1]
        ...
        cove = util.batchwise_cove(released, price, self.epsilon, battery_rating, battery_duration)
        # Compute penalties
